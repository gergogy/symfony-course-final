...
class InformationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('jobz_front_information_show', array('id' => $information->getId()));
        }
    ...
    public function editAction(Request $request, Information $information)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('jobz_front_information_edit', array('id' => $information->getId()));
        }
    ...
    public function deleteAction(Request $request, Information $information)
    {
        ...
        return $this->redirectToRoute('jobz_front_information_index');
    }
